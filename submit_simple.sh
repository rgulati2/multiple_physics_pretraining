...
#SBATCH --job-name="el_t14a"
#SBATCH --output="el_test14a.%j.out"
...
python train_basic1.py --run_name "el_test14a" --config "basic_config"  --yaml_config "./config/mpp_avit_b_config.yaml"  
